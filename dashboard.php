...
<div class="seven"><h1><img src="icons/status.jpg" width="30px" height="30px">Photo-Upload</h1></div>
...
echo"<div class='cdf-networking-main-container'>
  <div class='inner-cdf-networking'>
       
<div class='networking-limited-flex'>
       
<div class='image-networking'>
  <img src='user-uploads/".$row['pic_upload']."' width='50px' height='50' style='border-radius: 50%;'>     
</div>
       
<div class='names-networking'>
<a href='#.php?users_id=$users_id'><h1>".$row['firstname']." ".$row['lastname']."</h1></a>
<p>".$row['town']."</p>
<p>".$row['home']."</p>
</div>
