...
<title>Cdf-Funding Approved Applicants Page</title>
...
<div class="inner-projects-type">
   <h3>Approved Companies For Funding</h3>                 
</div>
</div>
<!------project type------end-->
...
<div><p class="info-7">Monthly Repayment Amount</p></div>
</div>
...
<div class="inner-information-container2">
  ...
  <div><p class="info-17"><?php echo $row['monthly_repayment_period'];?></p></div>
</div>
