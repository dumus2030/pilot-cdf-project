...
<head>
  ...
  <link rel="Stylesheet" href="profile_users_networking_hub.css">
</head>
<body>
  ...
  <div class="main">
   ...
   <img src="logos/CDF_Logo.svg-white.png" class="nav-logiz">
   </div>
   ...
   <div class="nav-links">
   <ul>
   <li><a href="#"><img src="user_icons/search 5.png">Find Friends</a></li>
   <li><a href="#"><img src="user_icons/house icon-white.png">All Users</a></li>
   <li><a href="form_downloads_networking.php"><img src="user_icons/news icon white.png" class="user-icon">Form Downloads</a></li>
   <li><a href="#"><img src="user_icons/call-white.png" class="user-icon">Contact</a></li>
   <li><a href="#"><img src="user_icons/log-out-red.png" class="user-icon">Logout</a></li>
   <li><a href="#"><img src="user_icons/settings icon-white.png" class="settings-icon">Settings</a></li>           
   </ul>
   </div>
...
echo"<img src='user_icons/greens-icons/comment (2).png' class='comenting'>";      
  ...
  echo"<h4><a href='#?users_id=$users_id--".$row['post_id']."'>Comments</a></h4>";        
  echo"</div>";
