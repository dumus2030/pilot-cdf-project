...
<nav class="navigation">
                    ...
                    <div class="nav-links">
                    <ul>
                    <li><a href="search.php"><img src="user_icons/find friends.webp">Find Friends</a></li>
...
<form action="profile.php?firstname=<?php echo $firstname; ?> <?php echo $lastname; ?> <?php echo $lastname; ?>" method="POST" enctype="multipart/form-data">
