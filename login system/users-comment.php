...
<div class="form">
<form action="users-comment.php?users_id=$u_id" method="post" id="form-boxing">


<div class="input-field">
<img src="user-uploads/64672ca082a811.62924573.jpg" class="user-commenter-pic" style="border-radius: 50%;"width="50px" height="50px">  
</div>
