...
<form action="402.php?firstname=<?php echo $firstname; ?> <?php echo $lastname; ?>" method="POST" enctype="multipart/form-data">
...
echo"<a href='delete.php'><img src='user_icons/greens-icons/trash.png' class='trash'></a>";
echo"</div>";
...
echo"<img src='user_icons/greens-icons/comment (2).png' class='comenting'>";      
  ...
  echo"<h4><a href='comments2.php?user_post_id=".$row['post_id']."'>Comments</a></h4>";        
  echo"</div>";
