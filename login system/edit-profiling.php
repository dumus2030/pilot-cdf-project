...
$errors['area'] = "area is required";
     ...
     $sql = "UPDATE login_user SET `pic_upload`='$fileNameNew',`username`='$username', `town`='$town', `area`='$area', `home`='$home', `age`='$age', `email`='$email', `contact`='$contact'  WHERE email = '$email'";
     ...
     $_SESSION['email'] = $email;
      header('location:profile.php?update super Successful');
...
<div class="main-container">
  ...
  <img src="../200/default-icons/user-default 2.png" width="280px" height="330px">
  </div>
...
<a href="profile.php" class="btn-edit-profil-1">Update Profile</a>
</div>
...
<div class="profil-pic-green">
        <img src="../200/creative-profile-art/green profil.png" class="profil-green">
      </div>
  
      <div class="green">
      <img src="../200/creative-profile-art/green below2.png" class="green-below-1">
...
<form action="edit13.php" method="POST" enctype="multipart/form-data">
...
<textarea type="message" name="about" maxlength="120" cols="5" rows="5"  placeholder="About you-only use 120 charecters"><?php echo $row['about'];?></textarea>   
</label>
...
<textarea type="message" name="networking"  maxlength="120" cols="5" rows="5"  placeholder="Networking Interests-only use 120 charecters"><?php echo $row['networking'];?></textarea>   
</label>
