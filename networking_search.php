...
<link rel="stylesheet" href="networking_searching.css">
</head>
<body>
...
<form action="networking_search.php" method="POST">
...
<img src="logos/CDF_Logo.svg.png" class="logo">
...
echo"<div><a href='profile_users_networking_hub.php?users_id=".$row['users_id']."'><img src='user-uploads/".$row['pic_upload']."' width='100px' height='130px'></a></div>";      
echo"<div><a href='profile_users_networking_hub.php?users_id=$users_id'><p>Names:<br /><span class='namings'>".$row['firstname'].".".$row['username'].".".$row['lastname']."</span><br /></p></a></div>";
