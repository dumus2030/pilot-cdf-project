...
<title>CDF-Zambia Applicant Form View Page</title>
<link rel="Stylesheet" href="applicant_form_profileview.css">
</head>
<body>
...
if($user_registration_id <0 || $user_registration_id == ""){
header('location:profile_users_networking_hub.php?no user availbale');
}
...
$select_userid = "SELECT * FROM `user_loan_registration` WHERE user_registration_id = '$user_registration_id'";
$run_userid = mysqli_query($con,$select_userid);
...
echo"<div class='logo-image-defualt'>
<img src='logos/CDF_Logo.svg.png' width='280px' height='330px'>
</div>
                                         
                                      
<div class='logo-image'>
<img src='user-uploads/".$row['logo_image']."' width='280px' height='330px'>
</div>
                                        
                                      
                                       

<h1 class='welcome'>WELCOME<br />".$_SESSION['email']."</h1>
...
<div class='nav-links'>
<ul>
<li><a href='all_cdf_applicants.php'><img src='user_icons/house icon-black.png'>All Appllicants</a></li>
<li><a href='all_cdf_applicants.php'><img src='user_icons/find friends.webp'>Search For Appllicant</a></li>            
</ul>
</div>
       ...
       <div class='project-flex'>
        ...
        <div class='pro1'>
          <div class='pro1-inner'>
            <P>Project identification Number:<span class='code-numbers'>"
            .$row['project_identification_number']."' <br /></span></P>
        ...
        <div class='pro2-inner'>
          <p>YE/Zone/Ward Code Number:<span class='code-numbers'>".$row['yezoneward_code_number']."<br /></span></p>
          <p>WE/Zone/Ward Code Number:<span class='code-numbers'>".$row['wezone_ward_code_number']."<br /></span></p>
          <p>CE/Zone/Ward Code Number:<span class='code-numbers'></span>".$row['cezoneward_code_number']."<br /></span></p>
        </div>
        </div>
  ...
  <div class='white-paper2'>
    ...
    <div class='inner-paper2'>
       ...
       <div class='name-of-business'>
          ...
          <p><span class='code-numbers'>".$row['name_of_business_organization_company_group_cooperative_club']."</span></p>
          <hr>
        </div>
       
        <div class='legal-form'>
          <h1>2.Legal Form Of Applicant(Limited Company(SME)/Group/Cooperative/Club):</h1>
          <p><span class='code-numbers'>".$row['legal_form_Of_applicant_limited_company_sme_group_cooperative']."</span></p>
          <hr class='leagal-hr'>
        </div>
       ...
       <div class='date-of-company-registration'>
        ...
        <p><span class='code-numbers'>".$row['date_Of_company_group_cooperative_club_registration']."</span></p>
       ...
       <div class='tpin'>
        <h1>4.TPIN:</h1>
        <p><span class='code-numbers'>".$row['tipn']."</span></p>
        <hr class='tpin-hr'>
...
<div class='fill-in-div-1'>
  ...
  <div class='fill-in-div-2'>
    <p><span class='code-numbers1'>".$row['shareholder_name_one']."</span></p>
  </div>


<div class='fill-in-div-3'>
  <p><span class='code-numbers1'>".$row['nrc_name_one']."</span></p>
</div>


<div class='fill-in-div-4'>
  <p><span class='code-numbers1'>".$row['shareholding_percent_name_one']."</span></p>
</div>


<div class='fill-in-div-5'>
  <p><span class='code-numbers1'>".$row['position_in_business_name_one']."</span></p>
</div>
...
<div class='fill2-in-div'>
  ...
  <div class='fill2-in-div-1'>
    ...
    <div class='fill2-in-div-2'>
      <p><span class='code-numbers2'>".$row['shareholder_name_two']."</span></p>
    </div>
  
  
  <div class='fill2-in-div-3'>
    <p><span class='code-numbers2'>".$row['nrc_name_two']."</span></p>
  </div>
  
  
  <div class='fill2-in-div-4'>
    <p><span class='code-numbers2'>".$row['shareholding_percent_name_two']."</span></p>
  </div>
  
  
  <div class='fill2-in-div-5'>
    <p><span class='code-numbers2'>".$row['position_in_business_name_two']."</span></p>
  </div>
...
<div class='fill3-in-div'>
  ...
  <div class='fill3-in-div-1'>
    ...
    <div class='fill3-in-div-2'>
      <p><span class='code-numbers1'>".$row['shareholder_name_three']."</span></p>
    </div>
  
  
  <div class='fill3-in-div-3'>
    <p><span class='code-numbers1'>".$row['nrc_name_three']."</span></p>
  </div>
  
  
  <div class='fill3-in-div-4'>
    <p><span class='code-numbers1'>".$row['shareholding_percent_name_three']."</span></p>
  </div>
  
  
  <div class='fill3-in-div-5'>
    <p><span class='code-numbers1'>".$row['position_in_business_name_three']."</span></p>
  </div>
...
<div class='fill4-in-div'>
  ...
  <div class='fill4-in-div-1'>
    ...
    <div class='fill4-in-div-2'>
      <p><span class='code-numbers2'>".$row['shareholder_name_four']."</span></p>
    </div>
  
  
  <div class='fill4-in-div-3'>
    <p><span class='code-numbers2'>".$row['nrc_name_four']."</span></p>
  </div>
  
  
  <div class='fill4-in-div-4'>
    <p><span class='code-numbers2'>".$row['shareholding_percent_name_four']."</span></p>
  </div>
  
  
  <div class='fill4-in-div-5'>
    <p><span class='code-numbers2'>".$row['position_in_business_name_four']."</span></p>
  </div>
...
<div class='fill5-in-div'>
  ...
  <div class='fill5-in-div-1'>
    ...
    <div class='fill5-in-div-2'>
      <p><span class='code-numbers1'>".$row['shareholder_name_five']."</span></p>
    </div>
  
  
  <div class='fill5-in-div-3'>
    <p><span class='code-numbers1'>".$row['nrc_name_five']."</span></p>
  </div>
  
  
  <div class='fill5-in-div-4'>
    <p><span class='code-numbers1'>".$row['shareholding_percent_name_five']."</span></p>
  </div>
  
  
  <div class='fill5-in-div-5'>
    <p><span class='code-numbers1'>".$row['position_in_business_name_five']."</span></p>
  </div>
...
<div class='fill6-in-div'>
  ...
  <div class='fill6-in-div-1'>
    ...
    <div class='fill6-in-div-2'>
      <p><span class='code-numbers2'></span>".$row['shareholder_name_six']."</span></p>
    </div>
  
  
  <div class='fill6-in-div-3'>
    <p><span class='code-numbers2'>".$row['nrc_name_six']."</span></p>
  </div>
  
  
  <div class='fill6-in-div-4'>
    <p><span class='code-numbers2'>".$row['shareholding_percent_name_six']."</span></p>
  </div>
  
  
  <div class='fill6-in-div-5'>
    <p><span class='code-numbers2'>".$row['position_in_business_name_six']."</span></p>
  </div>
...
<div class='fill7-in-div'>
  ...
  <div class='fill7-in-div-1'>
    ...
    <div class='fill7-in-div-2'>
      <p><span class='code-numbers1'>".$row['shareholder_name_seven']."</span></p>
    </div>
  
  
  <div class='fill7-in-div-3'>
    <p><span class='code-numbers1'>".$row['nrc_name_seven']."</span></p>
  </div>
  
  
  <div class='fill7-in-div-4'>
    <p><span class='code-numbers1'>".$row['shareholding_percent_name_seven']."</span></p>
  </div>
  
  
  <div class='fill7-in-div-5'>
    <p><span class='code-numbers1'>".$row['position_in_business_name_seven']."</span></p>
  </div>
...
<div class='fill8-in-div'>
  ...
  <div class='fill8-in-div-1'>
    ...
    <div class='fill8-in-div-2'>
      <p><span class='code-numbers2'>".$row['shareholder_name_eight']."</span></p>
    </div>
  
  
  <div class='fill8-in-div-3'>
    <p><span class='code-numbers2'>".$row['nrc_name_eight']."</span></p>
  </div>
  
  
  <div class='fill8-in-div-4'>
    <p><span class='code-numbers2'><span class='code-numbers2'>".$row['shareholding_percent_name_eight']."</span></p>
  </div>
  
  
  <div class='fill8-in-div-5'>
    <p><span class='code-numbers2'>".$row['position_in_business_name_eight']."</span></p>
  </div>
...
<div class='fill9-in-div'>
  ...
  <div class='fill9-in-div-1'>
    ...
    <div class='fill9-in-div-2'>
      <p><span class='code-numbers1'>".$row['shareholder_name_nine']."</span></p>
    </div>
  
  
  <div class='fill9-in-div-3'>
    <p><span class='code-numbers1'>".$row['nrc_name_nine']."</span></p>
  </div>
  
  
  <div class='fill9-in-div-4'>
    <p><span class='code-numbers1'>".$row['shareholding_percent_name_nine']."</span></p>
  </div>
  
  
  <div class='fill9-in-div-5'>
    <p><span class='code-numbers1'>".$row['position_in_business_name_nine']."</span></p>
  </div>
...
<div class='fill10-in-div'>
  ...
  <div class='fill10-in-div-1'>
    ...
    <div class='fill10-in-div-2'>
      <p><span class='code-numbers2'>".$row['shareholder_name_ten']."</span></p>
    </div>
  
  
  <div class='fill10-in-div-3'>
    <p><span class='code-numbers2'>".$row['nrc_name_ten']."</span></p>
  </div>
  
  
  <div class='fill10-in-div-4'>
    <p><span class='code-numbers2'>".$row['shareholding_percent_name_ten']."</span></p>
  </div>
  
  
  <div class='fill10-in-div-5'>
    <p><span class='code-numbers2'>".$row['position_in_business_name_ten']."</span></p>
  </div>
...
<div class='fill11-in-div'>
  ...
  <div class='fill11-in-div-1'>
    ...
    <div class='fill11-in-div-2'>
      <p><span class='code-numbers1'>".$row['shareholder_name_eleven']."</span></p>
    </div>
  
  
  <div class='fill11-in-div-3'>
    <p><span class='code-numbers1'>".$row['nrc_name_eleven']."</span></p>
  </div>
  
  
  <div class='fill11-in-div-4'>
    <p><span class='code-numbers1'>".$row['shareholding_percent_name_eleven']."</span></p>
  </div>
  
  
  <div class='fill11-in-div-5'>
    <p><span class='code-numbers1'>".$row['position_in_business_name_eleven']."</span></p>
  </div>
...
<p>Name Of Contact Person:<span class='code-numbers1'>".$row['authorized_representertive_name_of_contact_person']."</span></p>
</div>
...
<div class='authorized-div-3'>
  <p><span class='code-numbers1'>".$row['authorized_representertive_position_in_business']."</span></p>
</div>
...
<div class='authorized-section2-div-2'>
  <p>Cell:<span class='code-numbers1'>".$row['authorized_representertive_contact_number_cell']."</span></p>
</div>


<div class='authorized-section2-div-3'>
  <p>Telephone Number<br /><span class='code-numbers1'>".$row['authorized_representertive_contact_number_telephone']."</span></p>
</div>
...
<div class='authorized-section3-div-2'>
  <p><span class='code-numbers1'>ludocius@yahoo.com".$row['authorized_representertive_email']."</span></p>
</div>
...
<div class='names-of-district'>
  <h1>(a).Name Of District: <span class='code-numbers3'>".$row['project_location_name_of_district']."</span></h1><br />
  <h1>(a).Name Of constituency: <span class='code-numbers3'>".$row['project_location_name_of_constituency']."</span></h1><br />
  <h1>(a).Name Of Ward: <span class='code-numbers3'><span class='code-numbers1'>".$row['project_location_name_of_ward']."</span></h1><br />
  <h1>(a).Name Of Zone: <span class='code-numbers3'>".$row['project_location_name_of_zone']."</span></h1><br />
  <h1>(a).Physical Address: <span class='code-numbers3'>".$row['project_location_name_physical_address']."</span></h1><br />
...
<div class='details-of-loan-aplication1'>
  <p>1.Loan Application Amount (in Figures and words):<span class='code-numbers'>".$row['loan_application_amount_in_Figures']."<br /></span></p>
    
  <p>(K100,000):<span class='code-numbers'>".$row['loan_application_amount_in_words']."</span></p>
  ...
  <div class='white-paper6'>
   ...
   <h2>2.Description Of Business</h2><p>(eg, pottery, piggery, tailoring, metal fabrication etc)</p>
    ...
    <div class='discription-of-business-typing'>
      <p><span class='code-numbers2'>".$row['description_of_business']."</span></p>
    ...
    <div class='indicate-weather-typing'>
      <p><span class='code-numbers2'>".$row['indicate_weather_company_is_start_up']."</span></p>
    ...
    <div class='purpose-of-loan-typing'>
      <p><span class='code-numbers2'>".$row['purpose_of_the_loan']."</span></p>
    ...
    <div class='repayment-period-typing'>
      <p><span class='code-numbers2'>".$row['repayment_period']."</span></p>
    ...
    <div class='source-of-funds-for-repayment-typing'>
      <p><span class='code-numbers2'>".$row['source_of_funds_of_repayment_loan']."</span></p>
...
<div class='white-paper-collateral'>
  <div class='inner-paper-collateral'>
    ...
    <div class='collateral-typing'>
      <p><span class='code-numbers2'>".$row['collaterial_if_any']."</span></p>
...
<div class='Description-brakedown-row-one'>
     ...
     <div class='Description-brakedown-row-one2'>
      <p><span class='code-numbers1'>".$row['financials_description_cost_one']."</span></p>
    </div>


     <div class='Description-brakedown-row-one3'>
      <p><span class='code-numbers2'>".$row['financials_description_quality_one']."</span></p>
    </div>

     <div class='Description-brakedown-row-one4'>
     <p><span class='code-numbers2'>".$row['financials_description_unitcost_one']."</span></p>
    </div>


     <div class='Description-brakedown-row-one5'>
      <p><span class='code-numbers2'>".$row['financials_description_totalcost_one']."</span></p>
    </div>
...
<div class='Description-brakedown-row-two'>
  ...
  <div class='Description-brakedown-row-two2'>
   <p><span class='code-numbers1'>".$row['financials_description_cost_two']."</span></p>
 </div>


  <div class='Description-brakedown-row-two3'>
   <p><span class='code-numbers2'>".$row['financials_description_quality_two']."</span></p>
 </div>

  <div class='Description-brakedown-row-two4'>
   <p><span class='code-numbers2'>".$row['financials_description_unitcost_two']."</span></p>
 </div>


  <div class='Description-brakedown-row-two5'>
   <p><span class='code-numbers2'>".$row['financials_description_totalcost_two']."</span></p>
 </div>
...
<div class='Description-brakedown-row-three'>
  ...
  <div class='Description-brakedown-row-three2'>
   <p><span class='code-numbers1'>".$row['financials_description_cost_three']."</span></p>
 </div>


  <div class='Description-brakedown-row-three3'>
   <p><span class='code-numbers2'>".$row['financials_description_quality_three']."</span></p>
 </div>

  <div class='Description-brakedown-row-three4'>
   <p><span class='code-numbers2'>".$row['financials_description_unitcost_three']."</span></p>
 </div>


  <div class='Description-brakedown-row-three5'>
   <p><span class='code-numbers2'>".$row['financials_description_totalcost_three']."</span></p>
 </div>
...
<div class='Description-brakedown-row-four'>
  ...
  <div class='Description-brakedown-row-four2'>
   <p><span class='code-numbers1'>".$row['financials_description_cost_four']."</span></p>
 </div>


  <div class='Description-brakedown-row-four3'>
   <p><span class='code-numbers2'>".$row['financials_description_quality_four']."</span></p>
 </div>

  <div class='Description-brakedown-row-four4'>
   <p><span class='code-numbers2'>".$row['financials_description_unitcost_four']."</span></p>
 </div>


  <div class='Description-brakedown-row-four5'>
   <p><span class='code-numbers2'>".$row['financials_description_totalcost_four']."</span></p>
 </div>
...
<div class='Description-brakedown-row-five'>
  ...
  <div class='Description-brakedown-row-five2'>
   <p><span class='code-numbers1'>".$row['financials_description_cost_five']."</span></p>
 </div>


  <div class='Description-brakedown-row-five3'>
   <p><span class='code-numbers2'>".$row['financials_description_quality_five']."</span></p>
 </div>

  <div class='Description-brakedown-row-five4'>
   <p><span class='code-numbers2'>".$row['financials_description_unitcost_five']."</span></p>
 </div>


  <div class='Description-brakedown-row-five5'>
   <p><span class='code-numbers2'>".$row['financials_description_totalcost_five']."</span></p>
 </div>
...
<div class='Description-brakedown-row-six'>
  ...
  <div class='Description-brakedown-row-six2'>
   <p><span class='code-numbers1'>".$row['financials_description_cost_six']."</span></p>
 </div>


  <div class='Description-brakedown-row-six3'>
   <p><span class='code-numbers2'>".$row['financials_description_quality_six']."</span></p>
 </div>

  <div class='Description-brakedown-row-six4'>
   <p><span class='code-numbers2'>".$row['financials_description_unitcost_six']."</span></p>
 </div>


  <div class='Description-brakedown-row-six5'>
   <p><span class='code-numbers2'>".$row['financials_description_totalcost_six']."</span></p>
 </div>
...
<div class='Description-brakedown-row-seven'>
  ...
  <div class='Description-brakedown-row-seven2'>
   <p><span class='code-numbers1'>".$row['financials_description_cost_seven']."</span></p>
 </div>


  <div class='Description-brakedown-row-seven3'>
   <p><span class='code-numbers2'>".$row['financials_description_quality_seven']."</span></p>
 </div>

  <div class='Description-brakedown-row-seven4'>
   <p><span class='code-numbers2'>".$row['financials_description_unitcost_seven']."</span></p>
 </div>


  <div class='Description-brakedown-row-seven5'>
   <p><span class='code-numbers2'>".$row['financials_description_totalcost_seven']."</span></p>
 </div>
...
<div class='Description-brakedown-row-eight'>
  ...
  <div class='Description-brakedown-row-eight2'>
   <p><span class='code-numbers1'>".$row['financials_description_cost_eight']."</span></p>
 </div>


  <div class='Description-brakedown-row-eight3'>
   <p><span class='code-numbers2'>".$row['financials_description_quality_eight']."</span></p>
 </div>

  <div class='Description-brakedown-row-eight4'>
   <p><span class='code-numbers2'>".$row['financials_description_unitcost_eight']."</span></p>
 </div>


  <div class='Description-brakedown-row-eight5'>
   <p><span class='code-numbers2'>".$row['financials_description_totalcost_eight']."</span></p>
 </div>
...
<div class='Description-brakedown-row-nine'>
  ...
  <div class='Description-brakedown-row-nine2'>
   <p><span class='code-numbers1'>".$row['financials_description_cost_nine']."</span></p>
 </div>


  <div class='Description-brakedown-row-nine3'>
   <p><span class='code-numbers2'>".$row['financials_description_quality_nine']."</span></p>
 </div>

  <div class='Description-brakedown-row-nine4'>
   <p><span class='code-numbers2'>".$row['financials_description_unitcost_nine']."</span></p>
 </div>


  <div class='Description-brakedown-row-nine5'>
   <p><span class='code-numbers2'>".$row['financials_description_totalcost_nine']."</span></p>
 </div>
...
<div class='Description-brakedown-row-ten'>
  ...
  <div class='Description-brakedown-row-ten2'>
   <p><span class='code-numbers1'>".$row['financials_description_cost_ten']."</span></p>
 </div>


  <div class='Description-brakedown-row-ten3'>
   <p><span class='code-numbers2'>".$row['financials_description_quality_ten']."</span></p>
 </div>

  <div class='Description-brakedown-row-ten4'>
   <p><span class='code-numbers2'>".$row['financials_description_unitcost_ten']."</span></p>
 </div>


  <div class='Description-brakedown-row-ten5'>
   <p><span class='code-numbers2'>".$row['financials_description_totalcost_ten']."</span></p>
 </div>
...
<div class='Description-brakedown-row-eleven'>
  ...
  <div class='Description-brakedown-row-eleven2'>
   <p><span class='code-numbers1'>".$row['financials_description_cost_eleven']."</span></p>
 </div>


  <div class='Description-brakedown-row-eleven3'>
   <p><span class='code-numbers2'>".$row['financials_description_quality_eleven']."</span></p>
 </div>

  <div class='Description-brakedown-row-eleven4'>
   <p><span class='code-numbers2'>".$row['financials_description_unitcost_eleven']."</span></p>
 </div>


  <div class='Description-brakedown-row-eleven6'>
   <p><span class='code-numbers2'>".$row['financials_description_totalcost_eleven']."</span></p>
 </div>
...
<div class='Description-brakedown-row-twelve'>
  ...
  <div class='Description-brakedown-row-twelve2'>
   <p><span class='code-numbers1'>".$row['financials_description_cost_twelve']."</span></p>
 </div>


  <div class='Description-brakedown-row-twelve3'>
   <p><span class='code-numbers2'>".$row['financials_description_quality_twelve']."</span></p>
 </div>

  <div class='Description-brakedown-row-twelve4'>
   <p><span class='code-numbers2'>".$row['financials_description_unitcost_twelve']."</span></p>
 </div>


  <div class='Description-brakedown-row-twelve6'>
   <p><span class='code-numbers2'>".$row['financials_description_totalcost_twelve']."</span></p>
 </div>
...
<div class='Description-brakedown-row-thirteen'>
  ...
  <div class='Description-brakedown-row-thirteen2'>
   <p><span class='code-numbers1'>".$row['financials_description_cost_thirteen']."</span></p>
 </div>


  <div class='Description-brakedown-row-thirteen3'>
   <p><span class='code-numbers2'>".$row['financials_description_quality_thirteen']."</span></p>
 </div>

  <div class='Description-brakedown-row-thirteen4'>
   <p><span class='code-numbers2'>".$row['financials_description_unitcost_thirteen']."</span></p>
 </div>


  <div class='Description-brakedown-row-thirteen6'>
   <p><span class='code-numbers2'>".$row['financials_description_totalcost_thirteen']."</span></p>
 </div>
...
<div class='Description-brakedown-row-fourteen'>
 ...
 <p>14.</p>
  ...
  <div class='Description-brakedown-row-fourteen2'>
   <p><span class='code-numbers1'>".$row['financials_description_cost_fourteen']."</span></p>
 </div>


  <div class='Description-brakedown-row-fourteen3'>
   <p><span class='code-numbers2'>".$row['financials_description_quality_fourteen']."</span></p>
 </div>

  <div class='Description-brakedown-row-fourteen4'>
   <p><span class='code-numbers2'>".$row['financials_description_unitcost_fourteen']."</span></p>
 </div>


  <div class='Description-brakedown-row-fourteen6'>
   <p><span class='code-numbers2'>".$row['financials_description_totalcost_fourteen']."</span></p>
 </div>
...
<div class='Description-brakedown-row-sixteen'>
  ...
  <div class='Description-brakedown-row-sixteen6'>
   <p><span class='code-numbers1'>".$row['financials_description_totalcost_final']."</span></p>
 </div>
...
<div class='mothering-box2-projected-below1'>
 ...
 <div class='projected_level-div2-two-below2'>
   <h1><span class='code-numbers1'>".$row['projected_level_of_production_description_of_product_one']."</span></h1>
 </div>


 <div class='projected_level-div2-two-below3'>
   <h1><span class='code-numbers2'>".$row['projected_level_of_production_description_of_product_one_month1']."</span></h1>
 </div>

 <div class='projected_level-div2-two-below4'>
   <h1><span class='code-numbers2'>".$row['projected_level_of_production_description_of_product_one_month2']."</span></h1>
 </div>

 <div class='projected_level-div2-two-below5'>
   <h1><span class='code-numbers2'>".$row['projected_level_of_production_description_of_product_one_month3']."</span></h1>
 </div>

 <div class='projected_level-div2-two-below6'>
   <h1><span class='code-numbers2'>".$row['projected_level_of_production_description_of_product_one_month4']."</span></h1>
 </div>

 <div class='projected_level-div2-two-below7'>
   <h1><span class='code-numbers2'>".$row['projected_level_of_production_description_of_product_one_month5']."</span></h1>
 </div>

 <div class='projected_level-div2-two-below8'>
   <h1><span class='code-numbers2'>".$row['projected_level_of_production_description_of_product_one_month6']."</span></h1>
 </div>

 <div class='projected_level-div2-two-below9'>
   <h1><span class='code-numbers2'>".$row['projected_level_of_production_description_of_product_one_month7']."</span></h1>
 </div>

 <div class='projected_level_div2_two_below10'>
   <h2><span class='code-numbers2'>".$row['projected_level_of_production_description_of_product_one_month8']."</span></h2>
 </div>

 <div class='projected_level-div2-two-below11'>
   <h1><span class='code-numbers2'>".$row['projected_level_of_production_description_of_product_one_month9']."</span></h1>
 </div>

 <div class='projected_level_div_two_below122'>
   <h1><span class='code-numbers2'>".$row['projected_level_of_production_description_of_product_one_month10']."</span></h1>
 </div>

 <div class='projected_level-div2-two-below13'>
   <h1><span class='code-numbers2'>".$row['projected_level_of_production_description_of_product_one_month11']."</span></h1>
 </div>

 <div class='projected_level-div2-two-below14'>
   <h1><span class='code-numbers2'>".$row['projected_level_of_production_description_of_product_one_month12']."</span></h1>
 </div>

 <div class='projected_level-div2-two-below15'>
   <h1><span class='code-numbers2'>".$row['projected_level_of_production_description_of_product_one_year2']."</span></h1>
 </div>

 <div class='projected_level-div2-two-below16'>
   <h1><span class='code-numbers2'>".$row['projected_level_of_production_description_of_product_one_year3']."</span></h1>
 </div>

 <div class='projected_level-div2-two-below17'>
   <h1><span class='code-numbers2'>".$row['projected_level_of_production_description_of_product_one_year4']."</span></h1>
 </div>
...
<div class='mothering-box3-projected-below1'>
 ...
 <div class='projected_level-div3-two-below2'>
   <h1><span class='code-numbers1'>".$row['projected_level_of_production_description_of_product_two']."</span></h1>
 </div>


 <div class='projected_level-div3-two-below3'>
   <h1><span class='code-numbers2'>".$row['projected_level_of_production_description_of_product_two_month1']."</span></h1>
 </div>

 <div class='projected_level-div3-two-below4'>
   <h1><span class='code-numbers2'>".$row['projected_level_of_production_description_of_product_two_month2']."</span></h1>
 </div>

 <div class='projected_level-div3-two-below5'>
   <h1><span class='code-numbers2'>".$row['projected_level_of_production_description_of_product_two_month3']."</span></h1>
 </div>

 <div class='projected_level-div3-two-below6'>
   <h1><span class='code-numbers2'>".$row['projected_level_of_production_description_of_product_two_month4']."</span></h1>
 </div>

 <div class='projected_level-div3-two-below7'>
   <h1><span class='code-numbers2'>".$row['projected_level_of_production_description_of_product_two_month5']."</span></h1>
 </div>

 <div class='projected_level-div3-two-below8'>
   <h1><span class='code-numbers2'>".$row['projected_level_of_production_description_of_product_two_month6']."</span></h1>
 </div>

 <div class='projected_level-div3-two-below9'>
   <h1><span class='code-numbers2'>".$row['projected_level_of_production_description_of_product_two_month7']."</span></h1>
 </div>

 <div class='projected_level-div3-two-below10'>
   <h1><span class='code-numbers2'>".$row['projected_level_of_production_description_of_product_two_month8']."</span></h1>
 </div>

 <div class='projected_level-div3-two-below11'>
   <h1><span class='code-numbers2'>".$row['projected_level_of_production_description_of_product_two_month9']."</span></h1>
 </div>

 <div class='projected_level-div3-two-below12'>
   <h1><span class='code-numbers2'>".$row['projected_level_of_production_description_of_product_two_month10']."</span></h1>
 </div>

 <div class='projected_level-div3-two-below13'>
   <h1><span class='code-numbers2'>".$row['projected_level_of_production_description_of_product_two_month11']."</span></h1>
 </div>

 <div class='projected_level-div3-two-below14'>
   <h1><span class='code-numbers2'>".$row['projected_level_of_production_description_of_product_two_month12']."</span></h1>
 </div>

 <div class='projected_level-div3-two-below15'>
   <h1><span class='code-numbers2'>".$row['projected_level_of_production_description_of_product_two_year1']."</span></h1>
 </div>

 <div class='projected_level-div3-two-below16'>
   <h1><span class='code-numbers2'>".$row['projected_level_of_production_description_of_product_two_year2']."</span></h1>
 </div>

 <div class='projected_level-div3-two-below17'>
   <h1><span class='code-numbers2'>".$row['projected_level_of_production_description_of_product_two_year3']."</span></h1>
 </div>
...
<div class='mother-small-box-divs-two'>
 ...
 <p><span class='code-numbers2'>".$row['sales_projections_description_one']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below3-two'>
   <p><span class='code-numbers1'>".$row['sales_projections_description_one_m1']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below4-two'>
   <p><span class='code-numbers1'>".$row['sales_projections_description_one_m2']."</span></p>
 </div>
 
 <div class='mother-small-box-divs-below5-two'>
   <p><span class='code-numbers1'>".$row['sales_projections_description_one_m3']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below6-two'>
   <p><span class='code-numbers1'>".$row['sales_projections_description_one_m4']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below7-two'>
   <p><span class='code-numbers1'>".$row['sales_projections_description_one_m5']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below8-two'>
   <p><span class='code-numbers1'>".$row['sales_projections_description_one_m6']."</span></p>
 </div>
 
 <div class='mother-small-box-divs-below9-two'>
   <p><span class='code-numbers1'>".$row['sales_projections_description_one_m7']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below10-two'>
   <p><span class='code-numbers1'>".$row['sales_projections_description_one_m8']."</span></p>
 </div>
 
 <div class='mother-small-box-divs-below11-two'>
   <p><span class='code-numbers1'>".$row['sales_projections_description_one_m9']."></span></p>
 </div>
 
 <div class='mother-small-box-divs-below12-two'>
   <p><span class='code-numbers1'>".$row['sales_projections_description_one_m10']."</span></p>
 </div>
 
 <div class='mother-small-box-divs-below13-two'>
   <p><span class='code-numbers1'>".$row['sales_projections_description_one_m11']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below14-two'>
   <p><span class='code-numbers1'>".$row['sales_projections_description_one_m12']."</span></p>
 </div>
 ...
 <div class='mother-small-box-divs-below15-two'>
   <p><span class='code-numbers1'>".$row['sales_projections_description_one_totaly1']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below16-two'>
   <p><span class='code-numbers1'>".$row['sales_projections_description_one_unitprice_y1']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below17-two'>
   <p><span class='code-numbers1'>".$row['sales_projections_description_one_unitprice_y2']."</span></p>
 </div>
 
 
 
 <div class='mother-small-box-divs-below18-two'>
   <p><span class='code-numbers1'>".$row['sales_projections_description_one_unitprice_y3']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below19-two'>
   <p><span class='code-numbers1'>".$row['sales_projections_description_one_unitprice_y4']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below20-two'>
   <p><span class='code-numbers1'>".$row['sales_projections_description_one_totalsale_y1']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below21-two'>
   <p><span class='code-numbers1'>".$row['sales_projections_description_one_totalsale_y2']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below22-two'>
   <p><span class='code-numbers1'>".$row['sales_projections_description_one_totalsale_y3']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below23-two'>
   <p><span class='code-numbers1'>".$row['sales_projections_description_one_totalsale_y4']."</span></p>
 </div>
...
<div class='mother-small-box-divs-three'>
 ...
 <p><span class='code-numbers2'>".$row['sales_projections_description_two']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below3-three'>
   <p><span class='code-numbers1'>".$row['sales_projections_description2_one_m1']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below4-three'>
   <p><span class='code-numbers1'>".$row['sales_projections_description2_one_m2']."</span></p>
 </div>
 
 <div class='mother-small-box-divs-below5-three'>
   <p><span class='code-numbers1'>".$row['sales_projections_description2_one_m3']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below6-three'>
   <p><span class='code-numbers1'>".$row['sales_projections_description2_one_m4']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below7-three'>
   <p><span class='code-numbers1'>".$row['sales_projections_description2_one_m5']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below8-three'>
   <p><span class='code-numbers1'>".$row['sales_projections_description2_one_m6']."</span></p>
 </div>
 
 <div class='mother-small-box-divs-below9-three'>
   <p><span class='code-numbers1'>".$row['sales_projections_description2_one_m7']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below10-three'>
   <p><span class='code-numbers1'>".$row['sales_projections_description2_one_m8']."</span></p>
 </div>
 
 <div class='mother-small-box-divs-below11-three'>
   <p><span class='code-numbers1'>".$row['sales_projections_description2_one_m9']."</span></p>
 </div>
 
 <div class='mother-small-box-divs-below12-three'>
   <p><span class='code-numbers1'>".$row['sales_projections_description2_one_m10']."</span></p>
 </div>
 
 <div class='mother-small-box-divs-below13-three'>
   <p><span class='code-numbers1'>".$row['sales_projections_description2_one_m11']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below14-three'>
   <p><span class='code-numbers1'>".$row['sales_projections_description2_one_m12']."</span></p>
 </div>
 ...
 <div class='mother-small-box-divs-below15-three'>
   <p><span class='code-numbers1'>".$row['sales_projections_description2_one_totaly1']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below16-three'>
   <p><span class='code-numbers1'>".$row['sales_projections_description2_one_unitprice_y1']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below17-three'>
   <p><span class='code-numbers1'>".$row['sales_projections_description2_one_unitprice_y2']."</span></p>
 </div>
 
 
 
 <div class='mother-small-box-divs-below18-three'>
   <p><span class='code-numbers1'>".$row['sales_projections_description2_one_unitprice_y3']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below19-three'>
   <p><span class='code-numbers1'>".$row['sales_projections_description2_one_unitprice_y4']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below20-three'>
   <p><span class='code-numbers1'>".$row['sales_projections_description2_one_totalsale_y1']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below21-three'>
   <p><span class='code-numbers1'>".$row['sales_projections_description2_one_totalsale_y2']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below22-three'>
   <p><span class='code-numbers1'>".$row['sales_projections_description2_one_totalsale_y3']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below23-three'>
   <p><span class='code-numbers1'>".$row['sales_projections_description2_one_totalsale_y4']."</span></p>
 </div>
...
<div class='mother-small-box-divs-four'>
 ...
 <p><span class='code-numbers2'>".$row['sales_projections_description_three']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below3-four'>
   <p><span class='code-numbers1'>".$row['sales_projections_description3_one_m1']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below4-four'>
   <p><span class='code-numbers1'>".$row['sales_projections_description3_one_m2']."</span></p>
 </div>
 
 <div class='mother-small-box-divs-below5-four'>
   <p><span class='code-numbers1'>".$row['sales_projections_description3_one_m3']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below6-four'>
   <p><span class='code-numbers1'>".$row['sales_projections_description3_one_m4']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below7-four'>
   <p><span class='code-numbers1'>".$row['sales_projections_description3_one_m5']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below8-four'>
   <p><span class='code-numbers1'>".$row['sales_projections_description3_one_m6']."</span></p>
 </div>
 
 <div class='mother-small-box-divs-below9-four'>
   <p><span class='code-numbers1'>".$row['sales_projections_description3_one_m7']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below10-four'>
   <p><span class='code-numbers1'>".$row['sales_projections_description3_one_m8']."</span></p>
 </div>
 
 <div class='mother-small-box-divs-below11-four'>
   <p><span class='code-numbers1'>".$row['sales_projections_description3_one_m9']."</span></p>
 </div>
 
 <div class='mother-small-box-divs-below12-four'>
   <p><span class='code-numbers1'>".$row['sales_projections_description3_one_m10']."</span></p>
 </div>
 
 <div class='mother-small-box-divs-below13-four'>
   <p><span class='code-numbers1'>".$row['sales_projections_description3_one_m11']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below14-four'>
   <p><span class='code-numbers1'>".$row['sales_projections_description3_one_m12']."</span></p>
 </div>
 ...
 <div class='mother-small-box-divs-below15-four'>
   <p><span class='code-numbers1'>".$row['sales_projections_description3_one_totaly1']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below16-four'>
   <p><span class='code-numbers1'>".$row['sales_projections_description3_one_unitprice_y1']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below17-four'>
   <p><span class='code-numbers1'>".$row['sales_projections_description3_one_unitprice_y2']."</span></p>
 </div>
 
 
 
 <div class='mother-small-box-divs-below18-four'>
   <p><span class='code-numbers1'>".$row['sales_projections_description3_one_unitprice_y3']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below19-four'>
   <p><span class='code-numbers1'>".$row['sales_projections_description3_one_unitprice_y4']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below20-four'>
   <p><span class='code-numbers1'>".$row['sales_projections_description3_one_totalsale_y1']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below21-four'>
   <p><span class='code-numbers1'>".$row['sales_projections_description3_one_totalsale_y2']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below22-four'>
   <p><span class='code-numbers1'>".$row['sales_projections_description3_one_totalsale_y3']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below23-four'>
   <p><span class='code-numbers1'>".$row['sales_projections_description3_one_totalsale_y4']."</span></p>
 </div>
...
<div class='mother-small-box-divs-five'>
 ...
 <p><span class='code-numbers2'>".$row['sales_projections_description_four']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below3-five'>
   <p><span class='code-numbers1'>".$row['sales_projections_description4_one_m1']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below4-five'>
   <p><span class='code-numbers1'>".$row['sales_projections_description4_one_m2']."</span></p>
 </div>
 
 <div class='mother-small-box-divs-below5-five'>
   <p><span class='code-numbers1'>".$row['sales_projections_description4_one_m3']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below6-five'>
   <p><span class='code-numbers1'>".$row['sales_projections_description4_one_m4']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below7-five'>
   <p><span class='code-numbers1'>".$row['sales_projections_description4_one_m5']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below8-five'>
   <p><span class='code-numbers1'>".$row['sales_projections_description4_one_m6']."</span></p>
 </div>
 
 <div class='mother-small-box-divs-below9-five'>
   <p><span class='code-numbers1'>".$row['sales_projections_description4_one_m7']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below10-five'>
   <p><span class='code-numbers1'>".$row['sales_projections_description4_one_m8']."</span></p>
 </div>
 
 <div class='mother-small-box-divs-below11-five'>
   <p><span class='code-numbers1'>".$row['sales_projections_description4_one_m9']."</span></p>
 </div>
 
 <div class='mother-small-box-divs-below12-five'>
   <p><span class='code-numbers1'>".$row['sales_projections_description4_one_m10']."</span></p>
 </div>
 
 <div class='mother-small-box-divs-below13-five'>
   <p><span class='code-numbers1'>".$row['sales_projections_description4_one_m11']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below14-five'>
   <p><span class='code-numbers1'>".$row['sales_projections_description4_one_m12']."</span></p>
 </div>
 ...
 <div class='mother-small-box-divs-below15-five'>
   <p><span class='code-numbers1'>".$row['sales_projections_description4_one_totaly1']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below16-five'>
   <p><span class='code-numbers1'>".$row['sales_projections_description4_one_unitprice_y1']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below17-five'>
   <p><span class='code-numbers1'>".$row['sales_projections_description4_one_unitprice_y2']."</span></p>
 </div>
 
 
 
 <div class='mother-small-box-divs-below18-five'>
   <p><span class='code-numbers1'>".$row['sales_projections_description4_one_unitprice_y3']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below19-five'>
   <p><span class='code-numbers1'>".$row['sales_projections_description4_one_unitprice_y4']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below20-five'>
   <p><span class='code-numbers1'>".$row['sales_projections_description4_one_totalsale_y1']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below21-five'>
   <p><span class='code-numbers1'>".$row['sales_projections_description4_one_totalsale_y2']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below22-five'>
   <p><span class='code-numbers1'>".$row['sales_projections_description4_one_totalsale_y3']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below23-five'>
   <p><span class='code-numbers1'>".$row['sales_projections_description4_one_totalsale_y4']."</span></p>
 </div>
...
<div class='mother-small-box-divs-six'>
 ...
 <p><span class='code-numbers2'>".$row['sales_projections_description_five']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below3-six'>
   <p><span class='code-numbers1'>".$row['sales_projections_description5_one_m1']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below4-six'>
   <p><span class='code-numbers1'>".$row['sales_projections_description5_one_m2']."</span></p>
 </div>
 
 <div class='mother-small-box-divs-below5-six'>
   <p><span class='code-numbers1'>".$row['sales_projections_description5_one_m3']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below6-six'>
   <p><span class='code-numbers1'>".$row['sales_projections_description5_one_m4']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below7-six'>
   <p><span class='code-numbers1'>".$row['sales_projections_description5_one_m5']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below8-six'>
   <p><span class='code-numbers1'>".$row['sales_projections_description5_one_m6']."</span></p>
 </div>
 
 <div class='mother-small-box-divs-below9-six'>
   <p><span class='code-numbers1'>".$row['sales_projections_description5_one_m7']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below10-six'>
   <p><span class='code-numbers1'>".$row['sales_projections_description5_one_m8']."</span></p>
 </div>
 
 <div class='mother-small-box-divs-below11-six'>
   <p><span class='code-numbers1'>".$row['sales_projections_description5_one_m9']."</span></p>
 </div>
 
 <div class='mother-small-box-divs-below12-six'>
   <p><span class='code-numbers1'>".$row['sales_projections_description5_one_m10']."</span></p>
 </div>
 
 <div class='mother-small-box-divs-below13-six'>
   <p><span class='code-numbers1'>".$row['sales_projections_description5_one_m11']."</span></p>
 </div>
 
 
 <div class='mother-small-box-divs-below14-six'>
   <p><span class='code-numbers1'>".$row['sales_projections_description5_one_m12']."</span></p>
 </div>
 ...
 <div class='mother-small-box-divs-below15-six'>
   <h1><span class='code-numbers1'>".$row['sales_projections_description5_one_totaly1']."</span></h1>
 </div>
 
 
 <div class='mother-small-box-divs-below16-six'>
   <h1><span class='code-numbers2'>".$row['sales_projections_description5_one_tsaleunitprice_y1']."</span></h1>
 </div>
 ...
 <div class='mother-small-box-divs-below20-six'>
   <h1><span class='code-numbers1'>".$row['sales_projections_description5_one_totalsale_y1']."</span></h1>
 </div>
 
 
 <div class='mother-small-box-divs-below21-six'>
   <h1><span class='code-numbers1'>".$row['sales_projections_description5_one_totalsale_y2']."</span></h1>
 </div>
 
 
 <div class='mother-small-box-divs-below22-six'>
   <h1><span class='code-numbers1'>".$row['sales_projections_description5_one_totalsale_y3']."</span></h1>
 </div>
 
 
 <div class='mother-small-box-divs-below23-six'>
   <h1><span class='code-numbers1'>".$row['sales_projections_description5_one_totalsale_y4']."</span></h1>
 </div>
...
<section class='section-10'>
  ...
  <div class='operations-costs-div-4below'>
    ...
    <div class='operations-costs2-four'>
     <p><span class='code-numbers1'>".$row['projections_description_operatingcosts_one']."</span></p>
    </div>
  
  
    <div class='operations-costs3-four'>
     <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_one_m1']."</span></p>
    </div>
  
  
  
    <div class='operations-costs4-four'>
     <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_one_m2']."</span></p>
    </div>
  
  
    <div class='operations-costs5-four'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_one_m3']."</span></p>
     </div>
  
  
     <div class='operations-costs6-four'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_one_m4']."</span></p>
     </div>
   
  
     <div class='operations-costs7-four'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_one_m5']."</span></p>
     </div>
   
   
     <div class='operations-costs8-four'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_one_m6']."</span></p>
     </div>
   
  
  
     <div class='operations-costs9-four'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_one_m7']."</span></p>
     </div>
   
  
     <div class='operations-costs10-four'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_one_m8']."</span></p>
     </div>
   
  
  
     <div class='operations-costs11-four'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_one_m9']."</span></p>
     </div>
   
  
  
     <div class='operations-costs12-four'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_one_m10']."</span></p>
     </div>
   
  
  
     <div class='operations-costs13-four'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_one_m11']."</span></p>
     </div>
   
  
     <div class='operations-costs14-four'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_one_m12']."</span></p>
     </div>
   
  
  
     <div class='operations-costs15-four'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_one_y1']."</span></p>
     </div>
   
  
  
     <div class='operations-costs16-four'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_one_y2']."</span></p>
     </div>
  
  
     <div class='operations-costs17-four'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_one_y3']."</span></p>
     </div>
   
   
     <div class='operations-costs18-four'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_one_y4']."</span></p>
     </div>
  ...
  <div class='operations-costs-div-5below'>
    ...
    <div class='operations-costs2-five'>
     <p><span class='code-numbers1'>".$row['projections_description_operatingcosts_two']."</span></p>
    </div>
  
  
    <div class='operations-costs3-five'>
     <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_two_m1']."</span></p>
    </div>
  
  
  
    <div class='operations-costs4-five'>
     <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_two_m2']."</span></p>
    </div>
  
  
    <div class='operations-costs5-five'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_two_m3']."</span></p>
     </div>
  
  
     <div class='operations-costs6-five'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_two_m4']."</span></p>
     </div>
   
  
     <div class='operations-costs7-five'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_two_m5']."</span></p>
     </div>
   
   
     <div class='operations-costs8-five'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_two_m6']."</span></p>
     </div>
   
  
  
     <div class='operations-costs9-five'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_two_m7']."</span></p>
     </div>
   
  
     <div class='operations-costs10-five'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_two_m8']."</span></p>
     </div>
   
  
  
     <div class='operations-costs11-five'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_two_m9']."</span></p>
     </div>
   
  
  
     <div class='operations-costs12-five'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_two_m10']."</span></p>
     </div>
   
  
  
     <div class='operations-costs13-five'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_two_m11']."</span></p>
     </div>
   
  
     <div class='operations-costs14-five'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_two_m12']."</span></p>
     </div>
   
  
  
     <div class='operations-costs15-five'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_two_y1']."</span></p>
     </div>
   
  
  
     <div class='operations-costs16-five'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_two_y2']."</span></p>
     </div>
  
  
     <div class='operations-costs17-five'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_two_y3']."</span></p>
     </div>
   
   
     <div class='operations-costs18-five'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_two_y4']."</span></p>
     </div>
  ...
  <div class='operations-costs-div-6below'>
    ...
    <div class='operations-costs2-six'>
     <p><span class='code-numbers1'>".$row['projections_description_operatingcosts_three']."</span></p>
    </div>
  
  
    <div class='operations-costs3-six'>
     <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_three_m1']."</span></p>
    </div>
  
  
  
    <div class='operations-costs4-six'>
     <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_three_m2']."</span></p>
    </div>
  
  
    <div class='operations-costs5-six'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_three_m3']."</span></p>
     </div>
  
  
     <div class='operations-costs6-six'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_three_m4']."</span></p>
     </div>
   
  
     <div class='operations-costs7-five'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_three_m5']."</span></p>
     </div>
   
   
     <div class='operations-costs8-six'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_three_m6']."</span></p>
     </div>
   
  
  
     <div class='operations-costs9-six'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_three_m7']."</span></p>
     </div>
   
  
     <div class='operations-costs10-six'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_three_m8']."</span></p>
     </div>
   
  
  
     <div class='operations-costs11-six'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_three_m9']."</span></p>
     </div>
   
  
  
     <div class='operations-costs12-six'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_three_m10']."</span></p>
     </div>
   
  
  
     <div class='operations-costs13-six'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_three_m11']."</span></p>
     </div>
   
  
     <div class='operations-costs14-six'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_three_m12']."</span></p>
     </div>
   
  
  
     <div class='operations-costs15-six'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_three_y1']."</span></p>
     </div>
   
  
  
     <div class='operations-costs16-six'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_three_y2']."</span></p>
     </div>
  
  
     <div class='operations-costs17-six'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_three_y3']."</span></p>
     </div>
   
   
     <div class='operations-costs18-six'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_three_y4']."</span></p>
     </div>
  ...
  <div class='operations-costs-div-7below'>
    ...
    <div class='operations-costs2-seven'>
     <p><span class='code-numbers1'>".$row['projections_description_operatingcosts_four']."</span></p>
    </div>
  
  
    <div class='operations-costs3-seven'>
     <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_four_m1']."</span></p>
    </div>
  
  
  
    <div class='operations-costs4-seven'>
     <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_four_m2']."</span></p>
    </div>
  
  
    <div class='operations-costs5-seven'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_four_m3']."</span></p>
     </div>
  
  
     <div class='operations-costs6-seven'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_four_m4']."</span></p>
     </div>
   
  
     <div class='operations-costs7-seven'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_four_m5']."</span></p>
     </div>
   
   
     <div class='operations-costs8-seven'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_four_m6']."</span></p>
     </div>
   
  
  
     <div class='operations-costs9-seven'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_four_m7']."</span></p>
     </div>
   
  
     <div class='operations-costs10-seven'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_four_m8']."</span></p>
     </div>
   
  
  
     <div class='operations-costs11-seven'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_four_m9']."</span></p>
     </div>
   
  
  
     <div class='operations-costs12-seven'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_four_m10']."</span></p>
     </div>
   
  
  
     <div class='operations-costs13-seven'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_four_m11']."</span></p>
     </div>
   
  
     <div class='operations-costs14-seven'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_four_m12']."</span></p>
     </div>
   
  
  
     <div class='operations-costs15-seven'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_four_y1']."</span></p>
     </div>
   
  
  
     <div class='operations-costs16-seven'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_four_y2']."</span></p>
     </div>
  
  
     <div class='operations-costs17-seven'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_four_y3']."</span></p>
     </div>
   
   
     <div class='operations-costs18-seven'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_four_y4']."</span></p>
     </div>
  ...
  <div class='operations-costs-div-8below'>
    ...
    <div class='operations-costs2-eight'>
     <p><span class='code-numbers1'>".$row['projections_description_operatingcosts_five']."</span></p>
    </div>
  
  
    <div class='operations-costs3-eight'>
     <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_five_m1']."</span></p>
    </div>
  
  
  
    <div class='operations-costs4-eight'>
     <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_five_m2']."</span></p>
    </div>
  
  
    <div class='operations-costs5-eight'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_five_m3']."</span></p>
     </div>
  
  
     <div class='operations-costs6-eight'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_five_m4']."</span></p>
     </div>
   
  
     <div class='operations-costs7-eight'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_five_m5']."</span></p>
     </div>
   
   
     <div class='operations-costs8-eight'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_five_m6']."</span></p>
     </div>
   
  
  
     <div class='operations-costs9-eight'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_five_m7']."</span></p>
     </div>
   
  
     <div class='operations-costs10-eight'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_five_m8']."</span></p>
     </div>
   
  
  
     <div class='operations-costs11-eight'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_five_m9']."</span></p>
     </div>
   
  
  
     <div class='operations-costs12-eight'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_five_m10']."</span></p>
     </div>
   
  
  
     <div class='operations-costs13-eight'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_five_m11']."</span></p>
     </div>
   
  
     <div class='operations-costs14-eight'>
      <p><span class='code-numbers2'>".$row['projections_description_operatingcosts_five_m12']."</span></p>
     </div>
   
  
  
     <div class='operations-costs15-eight'>
      <h1><span class='code-numbers2'>".$row['projections_description_operatingcosts_totalsale']."</span></h1>
     </div>
...
<!----start of data 2 div-->
     ...
     <div class='data2-inner2'>
      <p>K<span class='code-numbers1'>".$row['what_is_the_monthly_revenue']."</span></p>
     </div>
...
<div class='data3'>
  ...
  <div class='data3-inner2'>
   <p>K<span class='code-numbers1'>".$row['what_is_the_total_operation_cost']."</span></p>
  </div>
...
<div class='data4'>
  ...
  <div class='data4-inner2'>
   <p>K<span class='code-numbers1'>".$row['what_is_the_total_current_operation_cost']."</span></p>
  </div>
...
<div class='data5'>
  ...
  <div class='data5-inner2'>
   <p>K<span class='code-numbers1'>".$row['what_is_the_total_investment_cost']."</span></p>
  </div>
...
<div class='data6'>
  ...
  <div class='data6-inner2'>
   <p>1.<span class='code-numbers1'>".$row['brakedown_of_investments1']."</span></p>
  </div>
...
<!-------------------start  previous-data2  -->
  ...
  <div class='previous-data2'>
    ...
    <div class='previous-data2-inner2'>
      <p><span class='code-numbers1'>".$row['finacialdata_If_Yes_Give_details']."</span></p>
    </div>
...
<div class='previous-data3'>
  ...
  <div class='previous-data3-inner2'>
    <p><span class='code-numbers1'>".$row['status_ofLoan_outstandingre_paid']."</span></p>
  </div>
...
<div class='previous-data4'>
  ...
  <div class='previous-data4-inner2'>
    <p><span class='code-numbers1'>".$row['finacialdata_name_ofbusiness']."</span></p>
  </div>
...
<section class='section-twelve'>
  ...
  <div class='one1'>
    <h1>1</h1>
     ...
     <div class='two2'>
      <p><span class='code-numbers1'>".$row['proposed_management_team_one_fullnames']."</span></p>
     </div>
  
  
     <div class='three3'>
      <p><span class='code-numbers2'>".$row['management_team_one_management_positions']."</span></p>
     </div>
  
  
     <div class='four4'>
      <p><span class='code-numbers2'>".$row['management_team_one_management_qualifications']."</span></p>
     </div>
  </div>
  ...
  <div class='proposed-management-inner3'>
    <div class='one2'>
     ...
     <div class='two22'>
      <p><span class='code-numbers1'>".$row['proposed_management_team_two_fullnames']."</span></p>
     </div>
  
  
     <div class='three33'>
      <p><span class='code-numbers2'>".$row['management_team_two_management_positions']."</span></p>
     </div>
  
  
     <div class='four44'>
      <p><span class='code-numbers2'>".$row['management_team_two_management_qualifications']."</span></p>
     </div>
  </div>
  ...
  <div class='proposed-management-inner4'>
    <div class='one3'>
     ...
     <div class='two222'>
      <p><span class='code-numbers1'>".$row['proposed_management_team_three_fullnames']."</span></p>
     </div>
  
  
     <div class='three333'>
      <p><span class='code-numbers2'>".$row['management_team_three_management_positions']."</span></p>
     </div>
  
  
     <div class='four444'>
      <p><span class='code-numbers2'>".$row['management_team_three_management_qualifications']."</span></p>
     </div>
  </div>
  </div>
  ...
  <div class='business-benefits1'>
   ...
   <div class='business-benefits-top2'>
    <p><span class='code-numbers1'>".$row['Business_benefit_customers']."</span></p>
   </div>
  ...
  <div class='business-bene2'>
    ...
    <p><span class='code-numbers1'>".$row['Business_benefit_suppliers']."</span></p>
    </div>
  ...
  <div class='business-bene3'>
    ...
    <div class='business-bene-top344'>
      <p><span class='code-numbers2'>".$row['Before_cdf_funding_women']."</span></p>
    </div>
  
  
    <div class='business-bene-top355'>
      <p><span class='code-numbers2'>".$row['after_cdf_funding_women']."</span></p>
    </div>
    ...
    <div class='business-bene-top3444'>
      <p><span class='code-numbers2'>".$row['Before_cdf_funding_men']."</span></p>
    </div>
  
  
    <div class='business-bene-top3555'>
      <p><span class='code-numbers2'>".$row['after_cdf_funding_men']."</span></p>
    </div>
    ...
    <div class='business-bene-top34441'>
      <p><span class='code-numbers2'>".$row['before_cdf_funding_all_total']."</span></p>
    </div>
    ...
    <div class='business-bene-top35551'>
      <p><span class='code-numbers2'>".$row['after_cdf_funding_all_total']."</span></p>
    </div>
  ...
  <div class='business-bene-top344411'>
    <p><span class='code-numbers2'>".$row['Before_cdf_funding_youth']."</span></p>
  </div>
  ...
  <div class='business-bene-top3555112'>
    <p><span class='code-numbers2'>".$row['after_cdf_funding_youth']."</span></p>
  </div>
  ...
  <div class='business-bene-top3444112'>
    <p><span class='code-numbers2'>".$row['Before_cdf_funding_physically_challenged']."</span></p>
  </div>
  ...
  <div class='business-bene-top35551120'>
    <p><span class='code-numbers2'>".$row['after_cdf_funding_physically_challenged']."</span></p>
  </div>
  ...
  <div class='top-capital-threshold-div-two'>
    ...
    <div class='top-capital-threshold-div1-inner-4-two'>
      <h1><span class='code-numbers1'>".$row['checkbox12_months']."</span></h1>
    </div>
  ...
  <div class='top-capital-threshold-div-three'>
    ...
    <div class='top-capital-threshold-div1-inner-4-three'>
      <h1><span class='code-numbers1'>".$row['checkbox18_months']."</span></h1>
    </div>
  ...
  <div class='top-capital-threshold-div-four'>
    ...
    <div class='top-capital-threshold-div1-inner-4-four'>
      <h1><span class='code-numbers1'>".$row['checkbox24_months']."</span></h1>
    </div>
  ...
  <div class='top-capital-threshold-div-five'>
    ...
    <div class='top-capital-threshold-div1-inner-4-five'>
      <h1><span class='code-numbers1'>".$row['checkbox36_months']."</span></h1>
    </div>
  ...
  <div class='top-capital-threshold-div-six'>
    ...
    <div class='top-capital-threshold-div1-inner-4-six'>
      <h1><span class='code-numbers1'>".$row['checkbox48_months']."</span></h1>
    </div>
...
<h2>12.Project Implimentation</h2>
  ...
  <div class='Project-Implimentation-div'>
   ...
   <div class='Project-Implimentation-div-inner3'>
    <P>".$row['checkbox1_3months']."</P>
   </div>


   <div class='Project-Implimentation-div-inner2'>
    <p>".$row['checkbox3_6months']."</p>
   </div>
   ...
   <div class='Project-Implimentation-div-inner-checkbox2'>
    <p>".$row['checkbox6_9months']."</p>
   </div>

   <div class='Project-Implimentation-div-inner-checkbox'>
    <p>".$row['checkbox_morethan9']."</p>
   </div>
...
<h1>Bank Name:</h1><hr><p>".$row['bank_name']."</p>
</div>

<div class='bank-name-container-div-2'>
  <h1>Branch:</h1><p>".$row['branch']."</p>
</div>


<div class='bank-name-container-div-3'>
  <h1>Soft Code:</h1><hr><p><p>".$row['soft_code']."</p>
</div>


<div class='bank-name-container-div-4'>
  <h1>Swift Code:</h1><p>".$row['swift_code']."</p>
</div>


<div class='bank-name-container-div-5'>
  <h1>Account Number:</h1><hr><p>".$row['account_number']."</p>
</div>


<div class='bank-name-container-div-6'>
  <h1>Tipn:</h1><p>".$row['tipn_user']."</p>
</div>


<div class='bank-name-container-div-7'>
  <h1>Mobil Money Name And Number:</h1><p>".$row['mobil_money_name_and_number']."</p>
</div>
...
<p>Full Names:<span class='code-numbers1'>".$row['club_secretary_name']."</span> </p><br />
<h3>Signature: ".$row['signature_image']."</h3><br />
<h4>Date:<span class='code-numbers2'>".$row['date_of_signing1']."</span></h4>
</div>
...
<h3>Signature: ".$row['head_of_business_signature_image']."</h3><br />
<h4>Date:<span class='code-numbers2'>".$row['date_of_signing2']."</span></h4>
</div>
