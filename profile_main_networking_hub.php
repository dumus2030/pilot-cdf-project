...
<title>postbox</title>
<link rel="Stylesheet" href="profile_main_networking_hub.css">
</head>
<body>
...
<nav class="navigation">
                    ...
                    <div class="nav-links">
                    <ul>
                    <li><a href="networking_search.php"><img src="user_icons/find friends.webp">Find Friends</a></li>
                    <li><a href="users.php"><img src="user_icons/house icon-black.png">All Users</a></li>
                    <li><a href="form_downloads_networking.php"><img src="user_icons/news icon black.png" class="user-icon">Form Downloads</a></li>
                    <li><a href="profile_main_networking_hub.php"><img src="user_icons/user black.png" class="user-icon">User Profile</a></li>
                    <li><a href="contact.php"><img src="user_icons/call.png" class="user-icon">Contact</a></li>
                    <li><a href="networking_logout.php"><img src="user_icons/log-ouy.png" class="user-icon">Logout</a></li>
                    <li><a href="networking_hub_edit_profile.php"><img src="user_icons/settings icon-black.png" class="settings-icon">Settings</a></li>           
                    </ul>
                    </div>
...
<p class="add-post-pic">Add Post Pic</p>
...
<form action="profile_main_networking_hub.php?firstname=<?php echo $firstname; ?> <?php echo $lastname; ?> <?php echo $lastname; ?>" method="POST" enctype="multipart/form-data">
...
<img src="user_icons/camera-adding.png" class="camera" width="50px" height="50px">
...
<div class="side-right">
  ...
  <div class="search">
  <h1 class="active-now">ACTIVE <span class="now">- NOW</span</h1>
  </div> 
...
echo"<h4><a href='comments2.php?users_id=$users_id,post_id=".$row['post_id']."'>Comments</a></h4>";        
echo"</div>";
