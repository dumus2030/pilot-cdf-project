...
header('location:login_networking_hub.php?Registration Successful');
...
<html lang="en">
 <head>
    ...
    <title>Networking Hub Registration page</title>
    <link rel="stylesheet" href="networking_hub_registration.css">
 </head>
  <body>
...
<a href="login_networking_hub.php" class="signing"><p><span><br />SIGN IN</span></p></a>
...
<div class="mother">
<form action="networking_hub_registration.php" method="POST">
