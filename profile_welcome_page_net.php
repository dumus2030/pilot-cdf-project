...
<title>postbox</title>
<link rel="Stylesheet" href="profile_welcome_net.css">
</head>
<body>
...
<nav class="navigation">
  ...
  <li><a href="logout_profile_welcome_page_net.php"><img src="user_icons/log-ouy.png" class="logout-icon">Logout</a></li>
...
if(empty($town) || empty($area) || empty($home) || empty($age) || empty($contact) || empty($about) || empty($networking)){
  ...
  echo"<div class='profile_update_instructions'>
...
elseif($town>0 || $area>0 || $home>0 || $age>0 || $contact>0 || $about>0 || $networking>0){
  header('location:profile_main_networking_hub.php?welcome');
}
