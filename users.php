...
<link rel="stylesheet" href="users_networking.css">
</head>
<body>
...
<div class="nav-links">
<ul>
<li><a href="profile_main_networking_hub.php"><img src="user_icons/house icon-black.png">Home</a></li>
<li><a href="form_downloads_networking.php">Form Downloads</a></li>
...
<li><a href="networking_logout.php">Logout</a></li>       
 </ul>             
</div>
...
<div>
<a href='profile_users_networking_hub.php?users_id=$users_id'>
...
<div>
<a style='text-decoration:none; cursor:pointer;color:#3897f0; 'href='profile_users_networking_hub.php?users_id=$users_id'>
